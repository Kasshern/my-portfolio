  ...
  return (
    ...
    >
      ...
      <div className="mb-8 text-center">
        <motion.a
          href="/resume"
          className="inline-block bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-6 py-3 rounded-lg text-lg font-semibold shadow-lg hover:from-blue-700 hover:to-cyan-700 transition-all focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-[#0a0a0a]"
        ...
        {links.map((link, idx) => (
          <li key={idx} className="relative">
            <motion.a
              ...
              className="relative block w-full text-center text-lg sm:text-xl md:text-2xl font-semibold text-blue-400 bg-gray-800 rounded-lg py-3 sm:py-4 shadow-lg hover:bg-blue-700 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-black overflow-hidden"
            ...
            {link.copyText && (
              <motion.button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 p-2 rounded-md bg-gray-700 hover:bg-gray-600 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <AnimatePresence>
              {copiedIndex === idx && (
                <motion.div
                  className="absolute -top-10 left-1/2 -translate-x-1/2 bg-green-600 text-white px-3 py-1 rounded-md text-sm font-medium shadow-lg"
